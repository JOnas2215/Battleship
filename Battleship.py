...
def main():
    ...
    print("---------------------------------- OPEN BETA ----------------------------------\nPlease be aware that there are some holes and mistakes in the code of this game.\nIt might run into errors when entering unusual responses.\n\n")
    ...
    while True:
        ...
        print(f"You have been shot at ({shot_computer[0]},{shot_computer[1]}). It was a {z.hit_or_miss(shot_computer, field_player1)}")
